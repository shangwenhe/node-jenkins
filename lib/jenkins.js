...
var Blueocean = require('./blueocean').Blueocean;
...
function Jenkins(opts) {
  ...
  this.workflow = new Jenkins.Workflow(this);
  this.blueocean = new Jenkins.Blueocean(this);
...
Jenkins.Job = Job;
Jenkins.Workflow = Workflow;
Jenkins.Blueocean = Blueocean;
Jenkins.Node = Node;
Jenkins.Queue = Queue;
Jenkins.View = View;
